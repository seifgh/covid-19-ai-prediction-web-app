...
def getPredictions():
	...
	#Importing data:
	df = pd.read_csv("app/artificial_intelligence/time_series_19-covid-Confirmed.csv")
	...
	x = pd.Series(x)
	x = x.append(pd.Series("3/19/20"))

	y = np.append(y.values.T,39)
